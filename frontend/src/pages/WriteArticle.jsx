  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      ...
      <div className="mb-6">
        {coverPreview ? (
          <div className="relative group">
            ...
            <button onClick={() => { setCoverImage(null); setCoverPreview(''); }}
      ...
      <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Title"
        className="w-full text-4xl font-bold font-serif text-gray-900 dark:text-gray-100 placeholder-gray-300 dark:placeholder-gray-600 bg-transparent border-none outline-none mb-6 resize-none" />
      ...
      <div className="flex flex-wrap items-center gap-2 mb-6 p-3 border border-gray-200 dark:border-gray-700 rounded-lg min-h-[44px] dark:bg-gray-800/40">
        {tags.map((tag) => (
          <span key={tag} className="flex items-center gap-1 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2.5 py-1 rounded-full">
            {tag}
            <button onClick={() => removeTag(tag)} className="text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-200">
